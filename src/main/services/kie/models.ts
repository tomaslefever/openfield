...
export const VIDEO_MODELS = [
  ...
  { id: 'pixverse-v6/text-to-video', name: 'PixVerse V6 T2V', cost: 0.020, unit: 's', category: 'PixVerse' },
  { id: 'pixverse-v6/image-to-video', name: 'PixVerse V6 I2V', cost: 0.020, unit: 's', category: 'PixVerse' },
  { id: 'pixverse-v6/transition', name: 'PixVerse V6 Transition', cost: 0.020, unit: 's', category: 'PixVerse' },
  { id: 'pixverse-v6/reference-to-video', name: 'PixVerse V6 Ref', cost: 0.0225, unit: 's', category: 'PixVerse' },
