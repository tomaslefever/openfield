...
import { Tags, Trash2, Plus, X, FolderInput, Check, Loader } from 'lucide-react'
...
export function BulkActionBar({ selectedCount, selectedIds, onAddTags, onDelete, onAddToComposer, onClearSelection, onAssetsMoved }: BulkActionBarProps) {
