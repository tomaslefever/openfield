 ...
 */
export function DeepSeekLogo({ size = 16, className = '', ...props }: ProviderLogoProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
    ...
    >
      <path
        d="M21.5 13.8c-.8-3.2-3.3-5.7-6.5-6.5-1.8-.5-3.8-.3-5.5.5-1.2.6-2.2 1.5-3 2.6-1.5 2.1-2 4.8-1.4 7.3.2.9.7 1.7 1.5 2.1.8.4 1.7.4 2.5 0 .8-.4 1.5-1.1 2-1.9.8-1.2 1.9-2.2 3.2-2.8 1.4-.6 3-.7 4.5-.4 1.1.2 2.1.8 2.7 1.7v-2.6z"
        fill="#0D53FF"
      />
      <circle cx="8" cy="11.5" r="1.5" fill="#FFFFFF" />
      <path
        d="M17.5 5.5c-1.2-1.4-2.8-2.3-4.7-2.5-.5-.1-1 .2-1.2.7-.2.5 0 1 .4 1.3 1.4.9 2.4 2.2 2.9 3.8.1.5.6.8 1.1.7.5-.1.9-.6.8-1.1 0-.3.4-1.9.7-2.9z"
        fill="#0D53FF"
      />
    </svg>
  )
 ...
 */
export function OpenAILogo({ size = 16, className = '', ...props }: ProviderLogoProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
 ...
 */
export function AnthropicLogo({ size = 16, className = '', ...props }: ProviderLogoProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
      height={size}
      fill="currentColor"
      className={`shrink-0 text-[#D97757] ${className}`}
      {...props}
    >
      <path d="M13.826 3.518h3.348L24 20.482h-3.478l-1.74-4.26H9.218l-1.74 4.26H4l6.826-16.964zm2.13 9.87l-1.956-4.826-1.957 4.826h3.913z" />
    </svg>
  )
}

/**
 * Google Gemini Official Spark Logo
 */
export function GeminiLogo({ size = 16, className = '', ...props }: ProviderLogoProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function ProviderLogo({ provider, size = 16, className = '' }: ProviderLogoComponentProps) {
  ...
  if (norm === 'deepseek') return <DeepSeekLogo size={size} className={className} />
